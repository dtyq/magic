...
import ChatMobileSkeleton from "@/opensource/pages/chatNew/lazy/skeleton/ChatMobileSkeleton"
...
import { notifyAppTabChange } from "@/opensource/layouts/BaseLayoutMobile/components/MobileTabBar/utils"

// Lazy load tab pages (只加载一次)
const WorkspacePage = lazy(() => import("@/opensource/pages/superMagicMobile/pages/ChatPage"))
const ChatPage = lazy(() => import("@/opensource/pages/chatNew"))
const ContactsPage = lazy(() => import("@/opensource/pages/contacts/lazy/Contacts"))
const ProfilePage = lazy(() => import("@/opensource/pages/user/pages/my/lazy/Profile"))
