import { MagicSelect, SubHeader } from "@admin-components"
...
} from "@admin/pages/PlatformPackage/components/ModalList/components/TestConnection"

const TestConnection = lazy(
	() => import("@admin/pages/PlatformPackage/components/ModalList/components/TestConnection"),
)
