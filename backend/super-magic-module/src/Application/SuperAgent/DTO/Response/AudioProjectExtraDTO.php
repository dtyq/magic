...
class AudioProjectExtraDTO
{
    ...
    {
        return new self(
            topicId: $entity->getTopicId() !== null ? (string) $entity->getTopicId() : null,
            modelId: $entity->getModelId(),
            taskKey: $entity->getTaskKey(),
            autoSummary: $entity->isAutoSummary(),
            source: $entity->getSource(),
            audioSource: $entity->getAudioSource(),
            audioFileId: $entity->getAudioFileId() !== null ? (string) $entity->getAudioFileId() : null,
    ...
    {
        return new self(
            topicId: isset($data['topic_id']) ? (string) $data['topic_id'] : null,
            modelId: $data['model_id'] ?? null,
            taskKey: $data['task_key'] ?? null,
            autoSummary: (bool) ($data['auto_summary'] ?? true),
            source: $data['source'] ?? 'app',
            audioSource: $data['audio_source'] ?? 'recorded',
            audioFileId: isset($data['audio_file_id']) ? (string) $data['audio_file_id'] : null,
