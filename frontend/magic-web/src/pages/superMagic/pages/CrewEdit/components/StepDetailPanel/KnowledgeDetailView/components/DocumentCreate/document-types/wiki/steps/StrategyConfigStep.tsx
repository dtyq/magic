...
import type { LocalDocumentStore, WikiDocumentStore } from "../../../store"
...
/**
 * Enterprise Wiki第2步：策略配置
 * 复用local-documents的策略配置组件
 * 设计稿: https://www.figma.com/design/6Y4cUmZyEJnas4qKtbcJ5Y/Magic---SuperMagic-Shadcn?node-id=14854-2359311
 */
