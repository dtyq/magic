...
return [
    ...
    'video_generation' => [
        'project_not_exists' => '项目不存在: :project_id',
        'file_dir_not_exists' => '文件目录不存在: :file_dir',
        'reference_file_not_exists' => '参考文件不存在: :file_key',
        'failed' => '视频生成失败',
        'submit_failed' => '视频任务提交失败',
        'query_failed' => '视频生成结果查询失败',
        'gateway_access_token_not_configured' => '视频网关访问令牌未配置',
        'operation_id_missing' => '未获取到视频操作ID',
        'video_url_missing' => '未获取到视频URL',
        'video_input_url_missing' => '无法获取输入文件URL: :file_key',
        'reference_image_url_missing' => '无法获取参考图片URL: :file_key',
        'frame_url_missing' => '无法获取帧图片URL: :file_key',
        'save_project_file_failed' => '保存项目文件失败: :file_key',
        'timeout' => '视频生成超时',
        'invalid_status' => '视频生成状态异常',
        'first_poll_dispatch_failed' => '视频任务调度失败',
    ],
