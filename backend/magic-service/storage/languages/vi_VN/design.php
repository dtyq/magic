...
return [
    'image_generation' => [
        ...
        'feature_unavailable' => 'Tính năng này hiện không khả dụng',
        'image_to_image_reference_required' => 'Chuyển ảnh sang ảnh cần ít nhất một ảnh tham chiếu',
    ],
    'image_mark_identify' => [
        'project_not_exists' => 'Project does not exist: :project_id',
    ...
    'video_generation' => [
        'project_not_exists' => 'Project does not exist: :project_id',
        'file_dir_not_exists' => 'File directory does not exist: :file_dir',
        'reference_file_not_exists' => 'Reference file does not exist: :file_key',
        'failed' => 'Video generation failed',
        'submit_failed' => 'Video task submission failed',
        'query_failed' => 'Failed to query video generation result',
        'gateway_access_token_not_configured' => 'Video gateway access token is not configured',
        'operation_id_missing' => 'Failed to obtain video operation ID',
        'video_url_missing' => 'Failed to obtain video URL',
        'video_input_url_missing' => 'Unable to get input file URL: :file_key',
        'reference_image_url_missing' => 'Unable to get reference image URL: :file_key',
        'frame_url_missing' => 'Unable to get frame image URL: :file_key',
        'save_project_file_failed' => 'Failed to save project file: :file_key',
        'timeout' => 'Video generation timed out',
        'invalid_status' => 'Video generation status is abnormal',
        'first_poll_dispatch_failed' => 'Video task dispatch failed',
    ],
