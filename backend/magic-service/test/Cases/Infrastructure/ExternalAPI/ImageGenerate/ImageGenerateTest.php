...
class ImageGenerateTest extends BaseTest
{
    ...
    public function testImage2ImagePlus()
    {
        ...
        // 测试需要跳过
        $url = '/41036eed2c3ada9fb8460883fcebba81/713471849556451329/project_867179699769765889/workspace/%E5%8E%9F%E5%9B%BE.png?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKTP0UfHn7baVh1S3LDR4c0hasMrCkUXmDuBizOgiVGLt4%2F20260115%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260115T093016Z&X-Tos-Expires=3600&X-Tos-Security-Token=nChBTb1JPZFIxelF1alV6OVlZEAE.-7QAVIbqzABh3ZWJzaXRlBYcMXX1SEkaiAARYAg.rwLdHyHZRivVSajszsXMbHxwLeJEm3oZZz9Z4AkyJwEeGs239H5Vs6lUjCIn0iiwlVfUMTbHRb-GD0guXm66QA&X-Tos-SignedHeaders=host&response-content-disposition=inline&response-content-type=image%2Fpng&x-tos-process=&X-Tos-Signature=42356e910bb1c4957ae93fd37e10fcc5f528a233ab13a7f43bbe48c34a1c9c7e';
        $MiracleVisionModelRequest = new MiracleVisionModelRequest($url);
        // 创建配置数组，包含必要的 ak 和 sk 参数
        $config = [
            'ak' => '111',
            'sk' => '222',
        ];
        $MiracleVisionModel = new MiracleVisionModel($config);
        // imageConvertHigh 现在直接返回图片URL，不再需要轮询
        $imageUrl = $MiracleVisionModel->imageConvertHigh($MiracleVisionModelRequest);
