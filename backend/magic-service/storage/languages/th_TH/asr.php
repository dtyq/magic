...
return [
    ...
    'messages' => [
        ...
        'summary_prefix' => 'โปรดช่วยฉันสรุปเนื้อหาการบันทึกเสียงใน ',
        'summary_suffix' => ' เป็นเอกสารรายงานการประชุม และสร้างรายงาน HTML วิเคราะห์ที่ละเอียด',
        // คำนำหน้า/ต่อท้าย i18n ใหม่ (มีบันทึก)
        'summary_prefix_with_note' => 'โปรดช่วยฉันจัดระเบียบเนื้อหาการบันทึกเสียงใน ',
        'summary_middle_with_note' => ' และเนื้อหาบันทึกของฉันใน ',
        'summary_suffix_with_note' => ' เป็นเอกสารรายงานการประชุม และรวมเนื้อหาบันทึกเพื่อสร้างรายงาน HTML วิเคราะห์ที่ละเอียด',
    ],
];
