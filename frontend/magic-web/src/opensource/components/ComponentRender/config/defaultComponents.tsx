...
const OrganizationItem = lazy(() => import("@/opensource/components/business/OrganizationItem"))

const OrganizationList = lazy(
	() =>
		import("@/opensource/layouts/BaseLayout/components/Sider/components/OrganizationSwitch/OrganizationList"),
)
// const OrganizationSwitch = lazy(
// 	() => import("@/opensource/layouts/BaseLayout/components/Sider/components/OrganizationSwitch"),
// )

const ContactsCurrentOrganization = lazy(
	() => import("@/opensource/pages/contacts/components/ContactsCurrentOrganization"),
)

const OrganizationAvatarRender = lazy(
	() => import("@/opensource/components/business/OrganizationAvatarRender"),
)
