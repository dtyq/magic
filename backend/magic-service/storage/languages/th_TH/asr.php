...
return [
    ...
    'messages' => [
        ...
        'summary_prefix' => 'โปรดช่วยฉันจัดระเบียบ ',
        'summary_suffix' => ' เนื้อหาการบันทึกเสียงเป็นเอกสารรายงานการประชุม และสร้างรายงาน HTML วิเคราะห์ที่ละเอียด',
        // คำนำหน้า/ต่อท้าย i18n ใหม่ (มีบันทึก)
        'summary_prefix_with_note' => 'โปรดช่วยฉันจัดระเบียบ ',
        'summary_middle_with_note' => ' เนื้อหาการบันทึกเสียงและ ',
        'summary_suffix_with_note' => ' เนื้อหาบันทึกของฉันเป็นเอกสารรายงานการประชุม และสร้างรายงาน HTML วิเคราะห์ที่ละเอียด',
    ],
];
