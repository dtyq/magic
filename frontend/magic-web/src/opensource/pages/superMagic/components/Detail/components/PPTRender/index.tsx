...
import {
	...
	AlertDialogHeader,
	AlertDialogTitle,
} from "@/opensource/components/shadcn-ui/alert-dialog"
...
import { useContainerShowButtonText } from "@/opensource/hooks/useContainerShowButtonText"
...
const PPTRender = function PPTRender(props: PPTRenderProps) {
	const { attachments, attachmentList, mainFileId, mainFileName, metadata, selectedProject } =
		props
