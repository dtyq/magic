...
class MessageScheduleAppServiceTest extends TestCase
{
    ...
    public function testMessageScheduleCallbackMissingId(): void
    {
        ...
        $result = MessageScheduleAppService::messageScheduleCallback([]);
    ...
    /**
     * Test messageScheduleCallback with null ID.
     * 测试消息定时任务ID为null的情况.
     */
    public function testMessageScheduleCallbackNullId(): void
    {
        $result = MessageScheduleAppService::messageScheduleCallback(['message_schedule_id' => null]);
    ...
    {
        $result = MessageScheduleAppService::messageScheduleCallback(['message_schedule_id' => 0]);
    ...
    public function testMessageScheduleCallbackMethodStructure(): void
    {
        ...
        $param = $parameters[0];
        $this->assertEquals('params', $param->getName(), 'Parameter should be named params');
        $paramType = $param->getType();
        $this->assertNotNull($paramType, 'Parameter should have type hint');
        $this->assertEquals('array', $paramType->getName(), 'Parameter should be array type');
    }
    ...
    {
        $result = MessageScheduleAppService::messageScheduleCallback(['message_schedule_id' => '123']);

        // Since the method uses (int) casting, string '123' should be converted to int 123
        // This would proceed to try to create the service instance
        // We can't fully test this without mocking di(), but we can verify structure
        $this->assertIsArray($result);
    ...
    public function testMessageScheduleCallbackInvalidIdFormats(): void
    {
        ...
        foreach ($invalidIds as $invalidId) {
            $result = MessageScheduleAppService::messageScheduleCallback(['message_schedule_id' => $invalidId]);
    ...
    public function testMessageScheduleCallbackWithRealId(): void
    {
        ...
        $params = ['message_schedule_id' => $realId];

        // Call the actual method
        $result = MessageScheduleAppService::messageScheduleCallback($params);
