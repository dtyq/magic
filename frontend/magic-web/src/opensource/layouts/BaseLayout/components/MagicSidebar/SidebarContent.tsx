...
import { ChevronRight, LayoutGrid, UsersRound } from "lucide-react"
...
import {
	...
	SidebarMenuButton,
	SidebarMenuItem,
} from "@/opensource/components/shadcn-ui/sidebar"
...
import { getRoutePath, routesPathMatch } from "@/opensource/routes/history/helpers"
...
const CollaborationProjectsPanel = lazy(
	() =>
		import("@/opensource/pages/superMagic/components/WorkspacesMenu/components/CollaborationProjectsPanel"),
)
			...
			<SidebarGroup className="w-full shrink-0 p-2" data-testid="sidebar-content-apps-group">
				<SidebarGroupContent>
					<SidebarMenu>
						...
						{sidebarMarketMenuItems.map(({ titleKey, routeName, testId, Icon }) => (
