...
import BaseRichText from "@/opensource/pages/superMagic/components/MessageList/components/Text/components/RichText"
...
import { MessageUsageType, Topic } from "@/opensource/pages/superMagic/pages/Workspace/types"
import { Button, Flex, MenuProps } from "antd"
import { splitNumber } from "@/opensource/utils/number"
			...
			return [
				{
					...
					label: (
						<div className="flex w-full cursor-default items-center gap-1 rounded px-1.5 py-1 text-[10px] font-normal text-muted-foreground">
						...
						<div className="mt-[6px] flex items-center justify-between gap-[4px]">
							...
							<div className="flex items-center gap-1">
								{allowConversationCopy && (
									<span
										className="inline-flex h-6 cursor-pointer items-center gap-1 rounded-lg border border-border bg-background px-2 py-0 text-xs leading-4 text-foreground hover:bg-muted hover:text-foreground"
