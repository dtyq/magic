...
func managedDocumentFromDomain(doc *documentdomain.KnowledgeBaseDocument) *ManagedDocument {
	if doc == nil {
		return nil
	}
...
func knowledgeBaseRuntimeSnapshotFromDomain(kb *knowledgebasedomain.KnowledgeBase) *sharedsnapshot.KnowledgeBaseRuntimeSnapshot {
	if kb == nil {
		return nil
	}
