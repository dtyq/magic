"""Completely real functionality tests for PdfLocalDriver - NO MOCKS ALLOWED."""
...
class TestPdfLocalDriver:
    """Test PdfLocalDriver with completely real file parsing - NO MOCKS."""

    def setup_method(self):
        self.file_parser = get_file_parser()
        self.driver = PdfLocalDriver()
    ...
    async def test_parse_pdf(self):
        ...
        output_file_path = self.sample_files_dir / 'output/pdf_local/dummy.pdf.md'
    ...
    async def test_parse_pdf_with_images(self):
        ...
        output_file_path = self.sample_files_dir / 'output/pdf_local/demo_with_image.pdf.md'
