...
import { getFileInfoByPath } from "@/opensource/pages/superMagic/components/Detail/contents/Design/utils/designFileInfoCache"
import {
	MarkerTypeEnum,
	type Marker,
	type MarkerArea,
	type MarkerPoint,
} from "@/opensource/components/CanvasDesign/canvas/types"
import type {
