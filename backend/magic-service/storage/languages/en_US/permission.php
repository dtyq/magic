...
return [
    'resource' => [
        ...
        'platform_agent_official' => 'Official Built-in Agents',
        'platform_agent_review' => 'Agent Review',
        'platform_agent_market' => 'Agent Market',
        'platform_skill_review' => 'Skill Review',
        'platform_skill_market' => 'Skill Market',
        'console' => 'Console',
        'api' => 'API',
        'api_assistant' => 'API Assistant',
        'platform' => 'Platform',
        'platform_ai' => 'Platform AI',
        'platform_agent' => 'Agent Management',
        'platform_skill' => 'Skill Management',
        'platform_model' => 'Platform Models',
        'platform_setting_application' => 'Application Menu',
        'platform_model_text' => 'Text Models',
        'platform_model_image' => 'Image Models',
        'platform_model_video' => 'Video Models',
        'workspace' => 'Workspace',
        'workspace_ai' => 'AI Management',
        'workspace_model' => 'Custom Models',
        'workspace_model_text' => 'Text Models',
        'workspace_model_image' => 'Image Models',
        'workspace_model_video' => 'Video Models',
