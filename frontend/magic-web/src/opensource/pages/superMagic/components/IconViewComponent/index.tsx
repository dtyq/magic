import SuperMagicIcon from "@/opensource/enhance/tabler/icons-react/icons/IconSuperMagic"
import { IconType } from "../AgentSelector/types"
import { useTheme } from "antd-style"
import { TablerIcon } from "@/opensource/utils/tablerIconLoader"
import OfficialTablerIcons from "@/opensource/assets/tabler-icons/tabler-icons-tags.json"
...
const IconComponent = (props: IconComponentProps) => {
	...
	// 如果icon类型为图片，则显示图片
	if (iconType === IconType.Image && iconUrl) {
		return (
			<div
				style={{
					...containerStyle,
