...
const VideoModelPage = lazy(() => import("./VideoModel/index.page"))
const VideoModelDetailPage = lazy(() => import("./VedioModelDetail/index.page"))
	...
	children: [
...

		{
			...
			children: [
				...
				{
					name: RouteName.AdminPlatformVideoModel,
					path: RoutePath.PlatformVideoModel,
					element: <VideoModelPage />,
				...
				{
					name: RouteName.AdminPlatformVideoModelDetails,
					path: RoutePath.PlatformVideoModelDetail,
					element: <VideoModelDetailPage />,
					validate: (permissions: string[], isSuperAdmin?: boolean) => {
						return (
							isSuperAdmin ||
							permissions.includes(
		...
		},
		{
			...
			children: [
				...
				{
					name: RouteName.AdminPlatformProviderAccess,
					path: RoutePath.PlatformProviderAccess,
					title: "nav.platformSubMenu.providerAccess",
