...
class VideoGenerationModel extends AbstractModel
{
    ...
    {
        throw new InvalidArgumentException('Video generation models do not support chat functionality');
    }
    ...
    {
        throw new InvalidArgumentException('Video generation models do not support chat stream functionality');
    }
    ...
    {
        throw new InvalidArgumentException('Video generation models do not support completions functionality');
    }
    ...
    {
        throw new InvalidArgumentException('Video generation models do not support embeddings functionality');
    }

    public function embedding(array|string $input, ?string $encoding_format = 'float', ?string $user = null): Embedding
    {
        throw new InvalidArgumentException('Video generation models do not support embedding functionality');
    }

    protected function getClient(): ClientInterface
    {
        throw new InvalidArgumentException('Video generation models do not require a client implementation');
    }
}
