import type { RecordingSession, SessionRestoreOptions } from "@/opensource/types/recordSummary"
import type { VoiceResultUtterance } from "@/opensource/components/business/VoiceInput/services/VoiceClient/types"
import {
	ProjectListItem,
	Topic,
	Workspace,
...
export class RecordingSessionManager {
	...
	createSession({
		...
		audioSource?: import("@/opensource/types/recordSummary").AudioSourceConfig
	}): RecordingSession {
		// 获取当前组织信息
