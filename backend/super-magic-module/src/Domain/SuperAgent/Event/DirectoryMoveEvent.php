 ...
 *
 * Used for asynchronous file/directory move operations when dealing with large numbers of files.
 */
class DirectoryMoveEvent
{
    /**
     * Constructor.
     *
     ...
     * @param mixed $fileEntity File entity
     * @param mixed $projectEntity Project entity
