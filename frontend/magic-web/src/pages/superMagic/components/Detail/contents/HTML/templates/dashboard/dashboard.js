	...
	"en-US": {
		...
		warning: {
			legendPositionRequired:
				"legend must explicitly declare position (left/right/top/bottom)",
			legendScrollRecommended:
				"legend should enable type: 'scroll' to avoid taking up too much space",
			gridContainLabelDeprecated:
				"grid.containLabel is deprecated in ECharts v6.0.0, recommend using { left: 0, right: 0, top: 0, bottom: 0, containLabel: false } configuration",
			gridPositionMustBeNumber: "must be a number, strings or percentages are not allowed",
			gridOuterBoundsUnnecessary:
				"grid.outerBounds should only be used when legend or visualMap components are configured, otherwise remove this configuration",
			gridOuterBoundsMustBeNumber: "must be a number, strings or percentages are not allowed",
			gridOuterBoundsRequired:
				"grid.outerBounds must be configured to reserve space when legend or visualMap components are present",
			gridNonZeroPosition:
				"has non-zero position values ({positions}). Consider using grid.outerBounds instead for better layout control when legend or visualMap components are present.",
			kpiDuplicateIcon:
				"KPI card has duplicate icon '{icon}' used {count} times at positions: {positions}. Consider using different icons for better visual distinction.",
			cardsWithoutLayout:
				"Found {count} card(s) without layout configuration out of {total} total cards: {cardIds}",
		},
	},
	"zh-CN": {
		// Common texts used across components
		...
		warning: {
			...
			gridContainLabelDeprecated:
				"grid.containLabel 在 ECharts v6.0.0 中已弃用，建议使用 { left: 0, right: 0, top: 0, bottom: 0, containLabel: false } 配置",
			gridPositionMustBeNumber: "必须为数字，不允许使用字符串或百分比",
			gridOuterBoundsUnnecessary:
				"grid.outerBounds 仅在配置了图例或视觉映射组件时使用，否则请移除此配置",
			gridOuterBoundsMustBeNumber: "必须为数字，不允许使用字符串或百分比",
			gridOuterBoundsRequired:
				"存在图例或视觉映射组件时，必须配置 grid.outerBounds 来预留空间",
			gridNonZeroPosition:
				"存在非零位置值 ({positions})。建议使用 grid.outerBounds 来获得更好的布局控制，特别是当存在图例或视觉映射组件时。",
			kpiDuplicateIcon:
				"KPI 卡片存在重复图标 '{icon}'，在第 {positions} 个位置使用了 {count} 次。建议使用不同的图标以获得更好的视觉区分度。",
						...
						if (current && _typeof(current) === "object" && key in current) {
							...
							console.warn(
								"Translation key not found: "
									.concat(keyPath, " for language: ")
									.concat(this.currentLanguage),
							)
			...
			},
			{
				...
				value: function renderErrorCard() {
					var _this$props$cardType = this.props.cardType,
						cardType =
							_this$props$cardType === void 0 ? "unknown" : _this$props$cardType
					var containerStyle = {
						height: "100%",
						display: "flex",
						flexDirection: "column",
			...
			value: function render() {
				...
				return React.createElement(
					...
					React.createElement(
						...
						language.t("filter.stringFilter.title"),
					),
					React.createElement("input", {
						type: "text",
						...
						style: {
							...
							fontSize: this.props.dashboardConfig.BASE_FONT_SIZE,
							height: "calc(".concat(
								this.props.dashboardConfig.TABLE_CELL_HEIGHT,
								" - 2px)",
							),
			...
			value: function render() {
				...
				return React.createElement(
					...
					React.createElement(
						...
						language.t("filter.numberFilter.title"),
					),
					React.createElement(
						"div",
						{
						...
						React.createElement("input", {
							...
							style: {
								...
								border: "1px solid ".concat(
									this.props.dashboardConfig.COLORS_BORDER,
								),
								borderRadius: "4px",
								fontSize: this.props.dashboardConfig.BASE_FONT_SIZE,
								height: "calc(".concat(
			...
			value: function render() {
				...
				return React.createElement(
					...
					React.createElement(
						...
						language.t("filter.dateFilter.title"),
					),
					React.createElement(
						"div",
						{
			...
			value: function render() {
				...
				return React.createElement(
					...
					React.createElement(
						...
						language.t("filter.timeFilter.title"),
					),
					React.createElement(
						"div",
						{
	...
	return _createClass(FilterPopup, [
		...
		},
		{
			...
			value: function componentDidUpdate(prevProps) {
				...
				if (
					...
					prevProps.buttonRect !== this.props.buttonRect ||
				...
				var popupContent = React.createElement(
					"div",
					{
						...
						style: {
							...
							border: "1px solid ".concat(
								((_this$props$dashboard = this.props.dashboardConfig) === null ||
								_this$props$dashboard === void 0
									? void 0
									: _this$props$dashboard.COLORS_BORDER) || "#ddd",
							),
							borderRadius: "6px",
							...
							transition:
								currentStyles.transition || "all 0.2s cubic-bezier(0.4, 0, 0.2, 1)",
						},
					},
						...
						"div",
						{
							style: {
								...
								borderTop: "1px solid ".concat(
									((_this$props$dashboard2 = this.props.dashboardConfig) ===
										null || _this$props$dashboard2 === void 0
										? void 0
										: _this$props$dashboard2.COLORS_BORDER) || "#eee",
								),
								display: "flex",
				...
				var popupContent = React.createElement(
					"div",
					{
						...
						style: {
							...
							color: "var(--color-text-primary, #1f2937)",
							border: "1px solid ".concat(
								((_this$props$dashboard3 = this.props.dashboardConfig) === null ||
								_this$props$dashboard3 === void 0
									? void 0
									: _this$props$dashboard3.COLORS_BORDER) || "#ddd",
							),
							borderRadius: "6px",
							boxShadow: "0 4px 12px rgba(0,0,0,0.15)",
							minWidth: "200px",
					...
					React.createElement(
						"div",
						{
							style: {
								padding: "8px",
								borderTop: "1px solid ".concat(
									((_this$props$dashboard4 = this.props.dashboardConfig) ===
										null || _this$props$dashboard4 === void 0
										? void 0
										: _this$props$dashboard4.COLORS_BORDER) || "#eee",
								),
								display: "flex",
								justifyContent: "space-between",
								gap: "8px",
		...
		},
		{
			...
			value: function adjustPopupPosition() {
				...
				finalLeft = Math.max(
					containerPadding,
					Math.min(finalLeft, viewportWidth - popupWidth - containerPadding),
				)
				...
				if (finalTop + popupHeight > viewportHeight - containerPadding) {
					...
					if (finalTop < containerPadding) {
						finalTop = Math.max(
							containerPadding,
							viewportHeight - popupHeight - containerPadding,
						)
					}
				}
				...
				switch (column.dataType) {
					case "number":
						return React.createElement(NumberFilter, {
							...
							placeholder: ""
								.concat(language.t("filter.numberFilter.title"), " ")
								.concat(column.title),
					...
					default:
						return React.createElement(StringFilter, {
							...
							onChange: handleChange,
							placeholder: ""
								.concat(language.t("filter.stringFilter.placeholder"), " ")
								.concat(column.title),
							dashboardConfig: this.props.dashboardConfig,
						})
				}
		...
		[
			{
				...
				value: function getMetricThemeConfig() {
					...
					return {
						...
						VALUE_FONT_SIZE: "".concat(baseFontSize * 1.7, "px"),
			...
			},
			{
				...
				value: function renderCircleIcon(icon, iconColor, themeConfig) {
					...
					var containerStyle = {
						...
						borderRadius: "50%",
						background: window.UTILS.getCircleGradientBackground(
							iconColor,
							themeConfig.PRIMARY,
						),
		...
		[
			{
				key: "preprocessData",
				value: (function () {
					var _preprocessData = _asyncToGenerator(
						/*#__PURE__*/ _regenerator().m(function _callee(data) {
		...
		[
					...
					function validateIconDuplication(indicators) {
						...
						if (duplicatedIcons.length > 0 && window.ErrorCollector) {
							duplicatedIcons.forEach(function (_ref3) {
								...
								var warningMessage = language.t(
									"warning.kpiDuplicateIcon",
									"KPI card has duplicate icon '{icon}' used {count} times at positions: {positions}. Consider using different icons for better visual distinction.",
									{
										icon: icon,
										count: count,
			...
			},
			{
				...
				value: function renderKPIRow(kpi, index) {
					...
					var isFirst = index === 0
					var fontSize = isFirst
						? themeConfig.LABEL_FONT_SIZE_FIRST
						: themeConfig.LABEL_FONT_SIZE
					var valueFontSize = isFirst
						? themeConfig.VALUE_FONT_SIZE_FIRST
						: themeConfig.VALUE_FONT_SIZE
				...
				value: function componentDidMount() {
					...
					if (this.props.data) {
						...
						var _parsedData$indicator = parsedData.indicators,
							indicators =
								_parsedData$indicator === void 0 ? [] : _parsedData$indicator
							...
							React.createElement(
								...
								indicators
									.map(function (indicator, index) {
										return [
											_this16.renderKPIRow(indicator, index),
		...
		[
			{
				key: "preprocessData",
				value: (function () {
					var _preprocessData2 = _asyncToGenerator(
						/*#__PURE__*/ _regenerator().m(function _callee2(data) {
								...
								style: {
									marginBottom:
										index < content.length - 1
											? themeConfig.PARAGRAPH_MARGIN_BOTTOM
											: "0",
								},
							},
							text,
			...
			},
			{
				...
				value: function render() {
					...
					var _parsedData$content = parsedData.content,
						...
						textAlign =
							_parsedData$textAlign === void 0 ? "left" : _parsedData$textAlign,
						_parsedData$fontSize = parsedData.fontSize,
						fontSize =
							_parsedData$fontSize === void 0
								? themeConfig.FONT_SIZE
								: _parsedData$fontSize,
						_parsedData$color = parsedData.color,
						color =
							_parsedData$color === void 0
								? themeConfig.TEXT_PRIMARY
								: _parsedData$color,
						_parsedData$fontWeigh = parsedData.fontWeight,
						fontWeight =
							_parsedData$fontWeigh === void 0 ? "normal" : _parsedData$fontWeigh,
						_parsedData$lineHeigh = parsedData.lineHeight,
						lineHeight =
							_parsedData$lineHeigh === void 0
								? themeConfig.LINE_HEIGHT
								: _parsedData$lineHeigh
					return React.createElement(
						"div",
						{
							style: {
		...
		[
			{
				key: "preprocessData",
				value: (function () {
					var _preprocessData3 = _asyncToGenerator(
		...
		[
			{
				key: "preprocessData",
				value: (function () {
					var _preprocessData4 = _asyncToGenerator(
						/*#__PURE__*/ _regenerator().m(function _callee4(data) {
...
var TableCard = /*#__PURE__*/ (function (_React$Component12) {
	function TableCard(props) {
		...
		_defineProperty(
			...
			function (scrollTop, containerHeight, rowHeight, totalRows) {
		...
		_defineProperty(_this18, "handleVirtualScroll", function (event) {
			...
			var _this18$calculateVisi = _this18.calculateVisibleRange(
					scrollTop,
					containerHeight,
					rowHeight,
					totalRows,
		...
		_defineProperty(_this18, "updateContainerHeight", function () {
			if (_this18.tableContainerRef.current) {
				...
				var totalRows = processedData.length
				var _this18$calculateVisi2 = _this18.calculateVisibleRange(
						_this18.state.scrollTop,
						containerHeight,
						rowHeight,
						totalRows,
					),
		...
		_defineProperty(_this18, "getDebouncedUpdateContainerHeight", function () {
			if (!_this18.debouncedUpdateContainerHeight) {
				var _window$UTILS
				_this18.debouncedUpdateContainerHeight =
					(_window$UTILS = window.UTILS) !== null &&
					_window$UTILS !== void 0 &&
					_window$UTILS.debounce
						? window.UTILS.debounce(_this18.updateContainerHeight, 100)
						: _this18.updateContainerHeight
			}
		...
		_defineProperty(_this18, "resetScrollToTop", function () {
			if (_this18.tableContainerRef.current) {
				...
				var totalRows = processedData.length
				var _this18$calculateVisi3 = _this18.calculateVisibleRange(
						0,
						containerHeight,
						rowHeight,
						totalRows,
		...
		_defineProperty(_this18, "buildColumnIndexes", function (tableData, columns) {
			...
			columns.forEach(function (column) {
				...
				tableData.forEach(function (row, rowIndex) {
					...
					// Build filter index
					if (cellValue != null) {
						var normalizedValue = _this18.normalizeValueForIndex(
							cellValue,
							column.dataType,
						)
				...
				if (column.sortable) {
					...
					_this18.sortedIndexes.set(
						columnKey,
						sortedRowIndexes.map(function (item) {
							return item.index
						}),
					)
				}
		...
		_defineProperty(_this18, "fastFilterData", function (tableData, filters, columns) {
			...
			Object.entries(filters).forEach(function (_ref4) {
				...
				if (columnIndexes) {
					...
					matchingIndexes = _this18.getMatchingIndexesFromIndex(
						columnIndexes,
						filterValue,
						column.dataType,
					)
					...
					matchingIndexes = _this18.getMatchingIndexesLinear(
						tableData,
						columnKey,
						filterValue,
						column.dataType,
				...
				if (resultIndexes === null) {
					...
					resultIndexes = new Set(
						_toConsumableArray(resultIndexes).filter(function (x) {
		...
		_defineProperty(
			_this18,
			"getMatchingIndexesFromIndex",
			function (columnIndexes, filterValue, dataType) {
				var matchingIndexes = new Set()
				switch (dataType) {
					case "number":
		...
		_defineProperty(
			_this18,
			"matchStringFromIndex",
			function (columnIndexes, filterValue, matchingIndexes) {
		...
		_defineProperty(
			_this18,
			"getMatchingIndexesLinear",
			function (tableData, columnKey, filterValue, dataType) {
				var matchingIndexes = new Set()
		...
		_defineProperty(_this18, "getProcessedData", function () {
			...
			if (
				cache.result &&
				cache.filters === filtersStr &&
				cache.sortColumn === sortColumn &&
			...
			if (sortColumn && sortDirection) {
				...
				if (sortColumnConfig && _this18.sortedIndexes.has(sortColumn)) {
					...
					if (sortDirection === "asc") {
						...
						filteredRowIndexes = preSortedIndexes
							.filter(function (idx) {
								return filteredSet.has(idx)
							})
							.reverse()
					...
					filteredData.sort(function (a, b) {
						var comparison = _this18.compareValues(
							a.data[sortColumn],
							b.data[sortColumn],
							sortColumnConfig.dataType,
						)
				...
				function (prevState) {
					return {
						filters: _objectSpread(
							_objectSpread({}, prevState.filters),
							{},
							_defineProperty({}, column.dataIndex, value),
						),
					}
				},
				function () {
		...
		_defineProperty(_this18, "showFilterPopup", function (column, event) {
			...
			var containerPadding =
				((_this18$props$dashboa = _this18.props.dashboardConfig) === null ||
				_this18$props$dashboa === void 0 ||
				(_this18$props$dashboa = _this18$props$dashboa.GRID_CONTAINER_PADDING) === null ||
				_this18$props$dashboa === void 0
					? void 0
					: _this18$props$dashboa[0]) || 8
			// Ensure popup doesn't exceed viewport boundaries, reserve container padding
			var viewportWidth = window.innerWidth
			var viewportHeight = window.innerHeight
			// Horizontal position adjustment
			var finalLeft = Math.max(
				containerPadding,
				Math.min(popupLeft, viewportWidth - popupWidth - containerPadding),
			)
			// Vertical position adjustment - if not enough space below, show above button
		...
		_defineProperty(_this18, "getTimeTimestamp", function (value) {
			...
			if (value.includes("T") || value.includes(" ")) {
				...
				if (timePart) {
					...
					if (_timeMatch) {
						var timeStr = ""
							.concat(_timeMatch[1].padStart(2, "0"), ":")
							.concat(_timeMatch[2].padStart(2, "0"))
			...
			if (timeMatch) {
				var _timeStr = ""
					.concat(timeMatch[1].padStart(2, "0"), ":")
					.concat(timeMatch[2].padStart(2, "0"))
		...
		_defineProperty(_this18, "filterDate", function (cellValue, filterValue) {
			...
			if (filterValue.includes(",")) {
				...
				if (startTs && !endTs) {
					...
					return (
						!isNaN(_startTimestamp3) &&
						!isNaN(_endTimestamp3) &&
						cellTimestamp >= _startTimestamp3 &&
						cellTimestamp <= _endTimestamp3
					)
				}
			}
			...
			return (
				cellDate.toLocaleDateString().includes(filterValue) ||
		...
		_defineProperty(_this18, "filterTime", function (cellValue, filterValue) {
			...
			var getCellTimestamp = function getCellTimestamp(value) {
				...
				if (value.includes("T") || value.includes(" ")) {
					...
					if (timePart) {
						...
						if (_timeMatch2) {
							var timeStr = ""
								.concat(_timeMatch2[1].padStart(2, "0"), ":")
								.concat(_timeMatch2[2].padStart(2, "0"))
							return new Date("".concat(today, "T").concat(timeStr, ":00")).getTime()
						}
					}
				}
			...
			if (filterValue.includes(",")) {
				...
				if (startTs && !endTs) {
					...
					return (
						!isNaN(_startTimestamp4) &&
						!isNaN(_endTimestamp4) &&
						cellTimestamp >= _startTimestamp4 &&
						cellTimestamp <= _endTimestamp4
					)
				}
			}
			// Compatible with traditional format (~ separator)
			if (filterValue.includes("~")) {
				...
				var _startTimestamp5 = new Date(
					"".concat(today, "T").concat(startTime, ":00"),
				).getTime()
				var _endTimestamp5 = new Date(
					"".concat(today, "T").concat(endTime, ":59"),
				).getTime()
							...
							React.createElement(
								"table",
								{
									style: {
										width: "100%",
										minWidth: "".concat(
											columns.length * parseInt(themeConfig.CELL_MIN_WIDTH),
											"px",
										),
										...
										React.createElement(
											...
											col.filterable &&
												(hoveredColumn === index ||
													...
													activeFilterPopup === col.dataIndex) &&
												React.createElement(
													"div",
													{
														className: "table-control-button ".concat(
															filters[col.dataIndex] ||
																activeFilterPopup === col.dataIndex
																? "active"
																: "",
													...
													React.createElement("i", {
														className: filters[col.dataIndex]
															? "ti ti-filter-filled"
															: "ti ti-filter",
														style: {
															fontSize: "12px",
															color: "#ffffff",
															opacity: filters[col.dataIndex]
																? 1
																: 0.7,
														},
													}),
			...
			},
			{
				...
				value: function renderVirtualTableBody(columns, visibleData, startIndex) {
					...
					return React.createElement(
						"tbody",
						null,
						visibleData.map(function (row, relativeIndex) {
							...
							return React.createElement(
								"tr",
								{
									...
									className: "table-row",
									style: {
										"--hover-color": "".concat(themeConfig.PRIMARY).concat(
											Math.round(themeConfig.HOVER_BACKGROUND_OPACITY * 255)
												.toString(16)
												.padStart(2, "0"),
										),
									},
								...
								columns.map(function (col, colIndex) {
									var cellValue = col.formatter
										? col.formatter(row[col.dataIndex])
										: row[col.dataIndex]
									return React.createElement(
										"td",
										{
		...
		[
			{
				key: "preprocessData",
				value: (function () {
					var _preprocessData5 = _asyncToGenerator(
						/*#__PURE__*/ _regenerator().m(function _callee5(data) {
					...
					function validateEChartsOption(option) {
							...
							if (!hasPosition) {
								warnings.push(
									""
										...
										.concat(
											language.t(
												"warning.legendPositionRequired",
												"legend must explicitly declare position (left/right/top/bottom)",
											),
										),
								)
							...
							if (!legend.type || legend.type !== "scroll") {
								warnings.push(
									""
										...
										.concat(
											language.t(
												"warning.legendScrollRecommended",
												"legend should enable type: 'scroll' to avoid taking up too much space",
											),
										),
								)
						...
						var validateGrid = function validateGrid(grid) {
							...
							if (grid.containLabel === true) {
								warnings.push(
									language.t(
										"warning.gridContainLabelDeprecated",
										"grid.containLabel is deprecated in ECharts v6.0.0, recommend using { left: 0, right: 0, top: 0, bottom: 0, containLabel: false } configuration",
									),
								)
							}
								...
								if (grid[prop] !== undefined && typeof grid[prop] === "string") {
									warnings.push(
										"grid."
											...
											.concat(
												language.t(
													"warning.gridPositionMustBeNumber",
													"must be a number, strings or percentages are not allowed",
												),
											),
									)
								}
							...
							var nonZeroPositions = ["left", "right", "top", "bottom"].filter(
								function (prop) {
							...
							if (grid.outerBounds) {
								if (!hasLegend && !hasVisualMap) {
									warnings.push(
										language.t(
											"warning.gridOuterBoundsUnnecessary",
											"grid.outerBounds should only be used when legend or visualMap components are configured, otherwise remove this configuration",
										),
									)
								}
								...
								;["left", "right", "top", "bottom"].forEach(function (prop) {
									if (
										grid.outerBounds[prop] !== undefined &&
										typeof grid.outerBounds[prop] !== "number"
									) {
										warnings.push(
											"grid.outerBounds."
												.concat(prop, " ")
												.concat(
													language.t(
														"warning.gridOuterBoundsMustBeNumber",
														"must be a number, strings or percentages are not allowed",
													),
												),
										)
								...
								var shouldSkipOuterBoundsCheck =
									isMapChart || (isPieChart && hasLegend && !hasVisualMap)
								if (!shouldSkipOuterBoundsCheck && (hasLegend || hasVisualMap)) {
									warnings.push(
										language.t(
											"warning.gridOuterBoundsRequired",
											"grid.outerBounds must be configured to reserve space when legend or visualMap components are present",
										),
									)
								}
									...
									while (1)
										switch ((_context6.p = _context6.n)) {
											case 0:
												...
												if (
													ChartCard.isValidEChartsOption(this.props.data)
												) {
													_context6.n = 2
													break
												}
												error = new Error(
													language.t(
														"error.invalidEChartsConfig",
														"Invalid ECharts configuration data",
													),
												)
												if (window.ErrorCollector) {
													window.ErrorCollector.collectInvalidEChartsConfigError(
														"ChartCard",
													)
												}
												throw error
											case 2:
												...
												if (
													this.chartInstanceRef &&
													this.chartInstanceRef.current
												) {
													this.chartInstanceRef.current.dispose()
												}
												// Get container dimensions
												containerRect =
													this.chartRef.current.getBoundingClientRect() // Initialize chart with theme
												...
												chart = echarts.init(
													...
													{
														width:
															containerRect.width === undefined
																? "auto"
																: containerRect.width,
														height:
															containerRect.height === undefined
																? "auto"
												...
												chart.on("error", function (chartError) {
													console.error(
														"ECharts internal error:",
														chartError,
													)
													if (window.ErrorCollector) {
														window.ErrorCollector.collectEChartsRenderError(
															chartError,
															"ChartCard",
														)
													}
													_this25.setState({
														error: new Error(
															language.t(
																...
																"Error occurred during chart rendering",
															),
														),
													})
												})
			...
			},
			{
				...
				value: function handleChartInit(context) {
					...
					return this.initChart().catch(function (error) {
						console.error(
							"Chart initialization failed during ".concat(context, ":"),
							error,
						)
						_this26.setState({
							error: error,
		...
		[
			{
				key: "preprocessData",
				value: (function () {
					var _preprocessData6 = _asyncToGenerator(
						/*#__PURE__*/ _regenerator().m(function _callee7(data) {
									...
									while (1)
										switch ((_context7.p = _context7.n)) {
											...
											case 1:
												...
												_context7.n = 2
												return window.MapManager.ensureMapsRegistered(
													mapNames,
												)
											case 2:
												success = _context7.v
												if (!success) {
													console.warn(
														"[ChartCard] Map preloading failed, but continue processing: ".concat(
															mapNames.join(", "),
														),
													)
												}
											...
											case 3:
												console.warn(
													"[ChartCard] MapManager not found, skip map preloading",
												)
											case 4:
											...
											case 5:
												...
												_t2 = _context7.v
												console.error(
													"[ChartCard] Data preprocessing failed:",
													_t2,
												)
												throw _t2
											case 6:
			...
			},
			{
				...
				value: function hasMapComponent(option) {
					...
					if (option.series) {
						var hasMapSeries = Array.isArray(option.series)
							? option.series.some(function (series) {
			...
			},
			{
				...
				value: function hasPieComponent(option) {
					...
					if (option.series) {
						var hasPieSeries = Array.isArray(option.series)
							? option.series.some(function (series) {
				...
				value: function generateThemeCSS() {
					...
					Object.keys(config).forEach(function (selector) {
						if (_typeof(config[selector]) === "object" && config[selector] !== null) {
							var styles = Object.entries(config[selector])
								.map(function (_ref8) {
								...
								.join("; ")
							cssRules.push(
								".markdown-content ".concat(selector, " { ").concat(styles, "; }"),
							)
						}
					})
				...
				value: function render() {
					...
					try {
						...
						return React.createElement(
							...
							""
								.concat(language.t("error.renderError", "Render error"), ": ")
		...
		[
			{
				key: "preprocessData",
				value: (function () {
					var _preprocessData7 = _asyncToGenerator(
						/*#__PURE__*/ _regenerator().m(function _callee8(data) {
			...
			},
			{
				...
				value: function getMarkdownThemeConfig(dashboardConfig) {
					var baseFontSize =
						(dashboardConfig === null || dashboardConfig === void 0
							? void 0
							: dashboardConfig.BASE_FONT_SIZE) || "14px"
					var textColor =
						(dashboardConfig === null || dashboardConfig === void 0
							? void 0
							: dashboardConfig.COLORS_TEXT_PRIMARY) || "#333333"
					return {
						...
						fontFamily:
							(dashboardConfig === null || dashboardConfig === void 0
								? void 0
								: dashboardConfig.BODY_FONT_FAMILY) ||
						...
						a: {
							color:
								(dashboardConfig === null || dashboardConfig === void 0
									? void 0
									: dashboardConfig.COLORS_PRIMARY) || "#0969da",
							textDecoration: "none",
						},
						table: {
							width: "100%",
	...
	return _createClass(Empty, [
		{
			...
			value: function getEmptyThemeConfig() {
				...
				return {
					ICON_COLOR:
						(config === null || config === void 0 ? void 0 : config.COLORS_BORDER) ||
						"#e6e7ea",
				}
			},
		},
		{
			...
			value: function render() {
				...
				var _this$props5 = this.props,
					...
					iconColor =
						_this$props5$iconColo === void 0
							? themeConfig.ICON_COLOR
							: _this$props5$iconColo,
	...
	return _createClass(BaseCard, [
		{
			...
			value: function notifyRenderStatusChange(status) {
				...
				if (
					this.hasNotifiedRenderComplete &&
									...
									switch (_context9.n) {
										...
										case 1:
											...
											this.handleGlobalMouseUp = function () {
												var draggingItems = document.querySelectorAll(
													".react-grid-item.dragging-immediate",
												)
		...
		},
		{
			...
			value: (function () {
				var _componentDidUpdate = _asyncToGenerator(
					/*#__PURE__*/ _regenerator().m(function _callee0(prevProps) {
						return _regenerator().w(
							function (_context0) {
								while (1)
									switch (_context0.n) {
										case 0:
											if (
												!(prevProps.getCardData !== this.props.getCardData)
											) {
												_context0.n = 1
												break
											}
		...
		},
		{
			key: "loadCardData",
			value: (function () {
				var _loadCardData = _asyncToGenerator(
									...
									switch ((_context1.p = _context1.n)) {
										case 0:
											;((_this$props6 = this.props),
												(getCardData = _this$props6.getCardData),
												(type = _this$props6.type)) // Notify loading start
											this.notifyRenderStatusChange("loading")
											// If no getCardData function is provided, set to no data state
											if (
												!(!getCardData || typeof getCardData !== "function")
											) {
												_context1.n = 1
												break
											}
										...
										case 4:
											...
											_t3 = _context1.v
											console.error(
												"[BaseCard] Raw data fetch failed (".concat(
													this.cardId,
													"):",
												),
												_t3,
											...
											error = new Error(
												"Data fetch failed: ".concat(_t3.message),
											)
											if (window.ErrorCollector) {
												window.ErrorCollector.collectDataFetchError(
													this.cardId,
													_t3,
													"BaseCard",
												)
										...
										case 5:
											...
											if (
												!(
													componentClass &&
													typeof componentClass.preprocessData ===
														"function"
												)
											) {
												_context1.n = 10
										...
										case 7:
											...
											if (
												processedData._preprocessed === false &&
												processedData._preprocessError
											) {
												console.warn(
													"[BaseCard] "
														.concat(
															type,
															" type data preprocessing has warning (",
														)
														.concat(this.cardId, "): ")
														.concat(processedData._preprocessError),
												)
											}
											_context1.n = 10
											break
										case 8:
											...
											console.error(
												"[BaseCard] "
													.concat(
														type,
														" type data preprocessing failed (",
													)
													.concat(this.cardId, "):"),
												_t4,
											)
											...
											_error = new Error(
												"Data format error: ".concat(_t4.message),
											)
											if (window.ErrorCollector) {
												window.ErrorCollector.collectDataFormatError(
													this.cardId,
													_t4,
													"BaseCard",
												)
										...
										case 9:
											...
											console.warn(
												"[BaseCard] Preprocessing failed, continue rendering with original data (".concat(
													this.cardId,
													")",
												),
											)
											processedData = _objectSpread(
												_objectSpread({}, rawData),
												{},
												{
													_preprocessed: false,
										...
										case 11:
											...
											_t5 = _context1.v
											console.error(
												"[BaseCard] Card data loading failed (".concat(
													this.cardId,
													"):",
												),
												_t5,
		...
		},
		{
			...
			value: function handleTitleInputBlur(event) {
				...
				var isClickingAlignmentButton =
					relatedTarget &&
					(relatedTarget.closest(".action-button.input-button") ||
						relatedTarget.classList.contains("input-button"))
				...
				return React.createElement(
					...
					[
						...
						React.createElement(
							...
							((_this$state$error = this.state.error) === null ||
							_this$state$error === void 0
								? void 0
								: _this$state$error.message) || language.t("common.error"),
						),
					],
				)
			},
		...
		},
		{
			...
			value: function createChildCard() {
				...
				if (
					...
					CardComponent !== this.renderDefaultContent
				) {
		...
		},
		{
			...
			value: function renderDragHandle() {
				...
				var isDraggable =
					((_this$props$editorCon = this.props.editorConfig) === null ||
					_this$props$editorCon === void 0
						? void 0
						: _this$props$editorCon.DRAGGABLE) || false
		...
		},
		{
			...
			value: function renderExpandButton() {
				var _this$props$editorCon2,
					_this29 = this
				var isExpandable =
					((_this$props$editorCon2 = this.props.editorConfig) === null ||
					_this$props$editorCon2 === void 0
						? void 0
						: _this$props$editorCon2.EXPANDABLE) || false
		...
		},
		{
			...
			value: function renderDeleteButton() {
				var _this$props$editorCon3,
					_this30 = this
				var isDeletable =
					((_this$props$editorCon3 = this.props.editorConfig) === null ||
					_this$props$editorCon3 === void 0
						? void 0
						: _this$props$editorCon3.DELETABLE) || false
				return this.renderActionButton({
					key: "delete-button",
					className: "action-button",
					icon: "ti ti-x",
		...
		},
		{
			...
			value: function renderAddTitleButton() {
				var _this$props$editorCon4,
					_this31 = this
				var isEditable =
					((_this$props$editorCon4 = this.props.editorConfig) === null ||
					_this$props$editorCon4 === void 0
						? void 0
						: _this$props$editorCon4.EDITABLE) || false
				return this.renderActionButton({
		...
		},
		{
			...
			value: function renderTitleAlignmentButton() {
				var _this$props$editorCon5,
					_this32 = this
				var isEditable =
					((_this$props$editorCon5 = this.props.editorConfig) === null ||
					_this$props$editorCon5 === void 0
						? void 0
						: _this$props$editorCon5.EDITABLE) || false
		...
		},
		{
			...
			value: function renderTitleContent(themeConfig) {
				var _this$props$editorCon6,
					_this33 = this
				var isEditable =
					((_this$props$editorCon6 = this.props.editorConfig) === null ||
					_this$props$editorCon6 === void 0
						? void 0
						: _this$props$editorCon6.EDITABLE) || false
					...
					return React.createElement(
						...
						[
							...
							React.createElement(
								...
								this.renderTitleAlignmentButton(),
							),
						].filter(Boolean),
					)
				} else {
		...
		},
		{
			...
			value: function renderActionButtons() {
				...
				var isExpandable =
					((_this$props$editorCon7 = this.props.editorConfig) === null ||
					_this$props$editorCon7 === void 0
						? void 0
						: _this$props$editorCon7.EXPANDABLE) || false
				var isDeletable =
					((_this$props$editorCon8 = this.props.editorConfig) === null ||
					_this$props$editorCon8 === void 0
						? void 0
						: _this$props$editorCon8.DELETABLE) || false
				var isEditable =
					((_this$props$editorCon9 = this.props.editorConfig) === null ||
					_this$props$editorCon9 === void 0
						? void 0
						: _this$props$editorCon9.EDITABLE) || false
				...
				var hasButtons = isAbsolute
					? (isEditable && !hasTitle) || isExpandable || isDeletable
					: isExpandable || isDeletable
		...
		},
		{
			...
			value: function calculateActionButtonsWidth() {
				...
				var isExpandable =
					((_this$props$editorCon0 = this.props.editorConfig) === null ||
					_this$props$editorCon0 === void 0
						? void 0
						: _this$props$editorCon0.EXPANDABLE) || false
				var isDeletable =
					((_this$props$editorCon1 = this.props.editorConfig) === null ||
					_this$props$editorCon1 === void 0
						? void 0
						: _this$props$editorCon1.DELETABLE) || false
				var themeConfig = this.getBaseCardThemeConfig()
				var buttonCount = 0
		...
		},
		{
			...
			value: function renderCardHeader() {
				...
				var titleElement = React.createElement(
					"div",
					{
		...
		},
		{
			key: "render",
			value: function render() {
				var _this$props$editorCon10,
					_this$props$editorCon11,
					_this$props$editorCon12,
					_React
				var hasTitle = !!this.cardTitle
				var isEditingTitle = this.state.isEditingTitle
				var isExpandable =
					((_this$props$editorCon10 = this.props.editorConfig) === null ||
					_this$props$editorCon10 === void 0
						? void 0
						: _this$props$editorCon10.EXPANDABLE) || false
				var isDeletable =
					((_this$props$editorCon11 = this.props.editorConfig) === null ||
					_this$props$editorCon11 === void 0
						? void 0
						: _this$props$editorCon11.DELETABLE) || false
				var isEditable =
					((_this$props$editorCon12 = this.props.editorConfig) === null ||
					_this$props$editorCon12 === void 0
						? void 0
						: _this$props$editorCon12.EDITABLE) || false
				...
				var containerStyle = _objectSpread(
					_objectSpread({}, this.getContainerStyle()),
					{},
					{
				...
				return React.createElement(
					...
					(_React = React).createElement.apply(
						_React,
						[React.Fragment, null].concat(_toConsumableArray(elements.filter(Boolean))),
					),
				)
			},
		},
	...
	return _createClass(ErrorCollector, [
			...
			value: function initGlobalErrorHandlers() {
				...
				window.addEventListener("unhandledrejection", function (event) {
					...
					_this35.collectError({
						...
						category: "RUNTIME",
						message:
							((_event$reason = event.reason) === null || _event$reason === void 0
								? void 0
								: _event$reason.message) || String(event.reason),
						stack:
							(_event$reason2 = event.reason) === null || _event$reason2 === void 0
								? void 0
								: _event$reason2.stack,
		...
		},
		{
			...
			value: function collectCSVLoadError(fileName, httpStatus, statusText) {
				var source =
					arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "CSVManager"
				return this.collectError({
		...
		},
		{
			...
			value: function collectInvalidFileNameError(fileName) {
				var source =
					arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "CSVManager"
				return this.collectError({
		...
		},
		{
			...
			value: function collectDataSourceNotFoundError(fileName) {
				...
				return this.collectError({
					...
					category: "DATA_LOAD",
					message: "File configuration not found in magicDashboard.dataSources: ".concat(
						fileName,
					),
					details: {
						fileName: fileName,
						availableConfigs:
							((_window$magicDashboar = window.magicDashboard) === null ||
							_window$magicDashboar === void 0 ||
							(_window$magicDashboar = _window$magicDashboar.dataSources) === null ||
							_window$magicDashboar === void 0
								? void 0
								: _window$magicDashboar.map(function (c) {
										return c.name
									})) || [],
					},
					source: source,
		...
		},
		{
			...
			value: function collectCSVParseError(fileName, parseError) {
				var source =
					arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "CSVManager"
				return this.collectError({
		...
		},
		{
			...
			value: function collectDataFetchError(cardId, dataError) {
				var source =
					arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "BaseCard"
				return this.collectError({
		...
		},
		{
			...
			value: function collectInvalidEChartsConfigError() {
				var source =
					arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "ChartCard"
				return this.collectError({
		...
		},
		{
			...
			value: function collectEChartsRenderError(chartError) {
				var source =
					arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "ChartCard"
				return this.collectError({
		...
		},
		{
			...
			value: function collectMapLoadError(mapUrl, httpStatus, statusText) {
				var source =
					arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "MapManager"
				return this.collectError({
		...
		},
		{
			...
			value: function collectCardsWithoutLayoutWarning(cardsWithoutLayout, totalCardsCount) {
				...
				var message = window.language
					? window.language.t("warning.cardsWithoutLayout", "", {
					...
					: "Found "
							.concat(
								cardsWithoutLayoutCount,
								" card(s) without layout configuration out of ",
							)
							.concat(totalCardsCount, " total cards: ")
							.concat(cardIds.join(", "))
		...
		},
		{
			...
			value: function getErrorStats() {
				...
				this.warnings.forEach(function (warning) {
					...
					stats.warningsByCategory[category] =
						(stats.warningsByCategory[category] || 0) + 1
				})
		...
		},
		{
			...
			value: function getCardErrorStats(cardIds) {
				...
				return {
					...
					totalErrorsForCards: Array.from(cardErrorCounts.values()).reduce(function (
						sum,
						count,
					) {
						return sum + count
...
var getDashboardDefaultConfig = function getDashboardDefaultConfig() {
	...
	return {
		...
		BODY_BACKGROUND_IMAGE: [
			"linear-gradient(135deg, rgba(49, 92, 236, 0.04) 0%, rgba(248, 250, 252, 0.6) 50%, #ffffff 100%)",
			"radial-gradient(circle at 15% 85%, rgba(49, 92, 236, 0.06) 0%, transparent 40%)",
			"radial-gradient(circle at 85% 15%, rgba(49, 92, 236, 0.03) 0%, transparent 40%)",
		],
		// Page font family
		BODY_FONT_FAMILY:
...
var getCircleGradientBackground = function getCircleGradientBackground(iconColor) {
	var fallbackColor =
		arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "#000000"
	...
	try {
		...
		var lightColor = "hsl("
			.concat(h, ", ")
			.concat(Math.min(s * 100 + 10, 80), "%, ")
			.concat(Math.min(l * 100 + 15, 75), "%)")
		var darkColor = "hsl("
			.concat(h, ", ")
			.concat(Math.min(s * 100 + 20, 90), "%, ")
			.concat(Math.max(l * 100 - 10, 40), "%)")
...
var getOpaqueBackgroundColor = function getOpaqueBackgroundColor() {
	...
	var cardBg = getComputedStyle(document.documentElement)
	...
	return _createClass(MapManager, [
		{
			key: "syncMapsConfig",
			value: (function () {
				var _syncMapsConfig = _asyncToGenerator(
					/*#__PURE__*/ _regenerator().m(function _callee10(newMapsConfig) {
						var newMaps,
							oldMaps,
							addedMaps,
							removedMaps,
								...
								while (1)
									switch ((_context10.p = _context10.n)) {
										...
										case 1:
											...
											console.log(
												"[MapManager] Starting map configuration synchronization",
											)
										...
										case 23:
											console.log(
												"[MapManager] Map configuration synchronization completed",
											)
										case 24:
											return _context10.a(2)
									}
		...
		},
		{
			key: "registerMap",
			value: (function () {
				var _registerMap = _asyncToGenerator(
					/*#__PURE__*/ _regenerator().m(function _callee11(map) {
								...
								while (1)
									switch ((_context11.p = _context11.n)) {
										case 0:
											...
											console.warn(
												"[MapManager] Invalid map configuration:",
												map,
											)
										...
										case 4:
											...
											return _context11.a(2, true)
										case 5:
											registrationPromise = this._performRegistration(
												name,
												url,
											)
		...
		},
		{
			...
			value: (function () {
				var _performRegistration2 = _asyncToGenerator(
					/*#__PURE__*/ _regenerator().m(function _callee12(name, url) {
								...
								while (1)
									switch ((_context12.p = _context12.n)) {
										...
										case 1:
											...
											if (window.ErrorCollector) {
												window.ErrorCollector.collectMapLoadError(
													url,
													response.status,
													response.statusText,
													"MapManager",
		...
		},
		{
			key: "unregisterMap",
			value: (function () {
				var _unregisterMap = _asyncToGenerator(
					/*#__PURE__*/ _regenerator().m(function _callee13(mapName) {
						var _t0
						return _regenerator().w(
							function (_context13) {
								while (1)
		...
		},
		{
			...
			value: (function () {
				var _ensureMapRegistered = _asyncToGenerator(
					/*#__PURE__*/ _regenerator().m(function _callee14(mapName) {
						var mapConfig
						return _regenerator().w(
							function (_context14) {
								while (1)
		...
		},
		{
			...
			value: (function () {
				var _ensureMapsRegistered = _asyncToGenerator(
					/*#__PURE__*/ _regenerator().m(function _callee16(mapNames) {
						var _this36 = this
						...
						return _regenerator().w(function (_context16) {
							while (1)
								switch (_context16.n) {
									...
									case 1:
										console.log(
											"[MapManager] Starting to ensure ".concat(
												mapNames.length,
												" maps are registered",
											),
										)
																		...
																		while (1)
																			switch (
																				...
																				case 0:
																					_context15.p = 0
																					_context15.n = 1
																					return _this36.ensureMapRegistered(
																						mapName,
																					)
																				case 1:
																					return _context15.a(
																				...
																				case 2:
																					...
																					_t1 =
																						_context15.v
																					console.error(
																						'[MapManager] Error occurred while ensuring map "'.concat(
																							mapName,
																							'" registration:',
																						),
																						_t1,
									...
									case 2:
										...
										console.log(
											"[MapManager] Map registration completed: "
												.concat(successCount, "/")
												.concat(mapNames.length, " successful"),
										)
	...
	return _createClass(CSVManager, [
		{
			...
			value: (function () {
				var _load = _asyncToGenerator(
					/*#__PURE__*/ _regenerator().m(function _callee18(fileName) {
								...
								while (1)
									switch ((_context18.p = _context18.n)) {
										case 0:
											...
											if (window.ErrorCollector) {
												window.ErrorCollector.collectInvalidFileNameError(
													fileName,
													"CSVManager",
												)
											}
										...
										case 4:
											loadingPromise = _asyncToGenerator(
												/*#__PURE__*/ _regenerator().m(
													function _callee17() {
															...
															function (_context17) {
																while (1)
																	switch (
																		...
																		case 0:
																			dataSourceConfig =
																				((_window$magicDashboar2 =
																					window.magicDashboard) ===
																					null ||
																				_window$magicDashboar2 ===
																					void 0
																					? void 0
																					: _window$magicDashboar2.dataSources) ||
																				[]
																			dataSource =
																				dataSourceConfig.find(
																					function (
																						config,
																					) {
																						return (
																			...
																			_error2 = new Error(
																				"File configuration not found in magicDashboard.dataSources: ".concat(
																					fileName,
																				),
																			)
																			if (
																				...
																				window.ErrorCollector.collectDataSourceNotFoundError(
																					fileName,
																					"CSVManager",
																				)
																			}
																		...
																		case 1:
																			...
																			console.log(
																				"[CSVManager] Starting to load file: ".concat(
																					fileName,
																				),
																			)
																			_context17.p = 2
																		...
																		case 3:
																			...
																			if (
																				...
																				window.ErrorCollector.collectCSVLoadError(
																					fileName,
																					response.status,
																					response.statusText,
																					"CSVManager",
																		...
																		case 5:
																			...
																			throw new Error(
																				"[CSVManager] PapaParse library not loaded, cannot parse CSV file: ".concat(
																					fileName,
																				),
																			)
																		case 6:
																						...
																						window.Papa.parse(
																							csvText,
																							{
																								...
																								complete:
																									function complete(
																										...
																										if (
																											...
																											console.warn(
																												"[CSVManager] CSV parsing warnings (".concat(
																													fileName,
																													"):",
																												),
																												results.errors,
																								...
																								error: function error(
																									...
																									console.error(
																										"[CSVManager] CSV parsing failed (".concat(
																											fileName,
																											"):",
																										),
																										_error4,
																									...
																									if (
																										...
																										window.ErrorCollector.collectCSVParseError(
																											fileName,
																											_error4,
																											"CSVManager",
																										)
...
function formatCSSValue(value) {
	...
	if (typeof value === "string") {
		...
		if (
			/^(auto|inherit|initial|unset|none|normal|bold|italic|center|left|right|top|bottom|middle|baseline)$/i.test(
				trimmedValue,
			)
		) {
			return trimmedValue
...
function applyThemeStyles(dashboardConfig) {
	...
	if (
		dashboardConfig.BODY_BACKGROUND_IMAGE &&
		Array.isArray(dashboardConfig.BODY_BACKGROUND_IMAGE)
	) {
		root.style.setProperty(
			"--body-background-image",
			dashboardConfig.BODY_BACKGROUND_IMAGE.join(", "),
		)
	}
	...
	if (dashboardConfig.CARD_TITLE_FONT_SIZE) {
		root.style.setProperty(
			"--card-title-font-size",
			formatCSSValue(dashboardConfig.CARD_TITLE_FONT_SIZE),
		)
	}
	if (dashboardConfig.CARD_BORDER_WIDTH) {
		root.style.setProperty(
			"--card-border-width",
			formatCSSValue(dashboardConfig.CARD_BORDER_WIDTH),
		)
	}
	...
	if (dashboardConfig.CARD_BORDER_RADIUS) {
		root.style.setProperty(
			"--card-border-radius",
			formatCSSValue(dashboardConfig.CARD_BORDER_RADIUS),
		)
	}
	...
	if (dashboardConfig.INTERACTION_CARD_HOVERABLE) {
		if (dashboardConfig.CARD_HOVER_BORDER_COLOR) {
			root.style.setProperty(
				...
				dashboardConfig.CARD_HOVER_BORDER_COLOR,
			)
		}
		if (dashboardConfig.CARD_HOVER_BORDER_STYLE) {
			root.style.setProperty(
				"--card-hover-border-style",
				dashboardConfig.CARD_HOVER_BORDER_STYLE,
			)
		}
	...
	return _createClass(MobileGridLayout, [
				...
				return cards
					.map(function (card) {
						return ""
							.concat(card.id, "-")
							.concat(card.type, "-")
							.concat(JSON.stringify(card.layout))
					})
					.join("|")
			},
		},
		...
		},
		{
			...
			value: function getCompactEChartsThemeName() {
				return ""
					.concat(window.ECHARTS_THEME_NAME || "dashboard", "_")
					.concat(this.getLayoutMode())
			},
		...
		},
		{
			...
			value: function calculateKPIHeight(cardData) {
				...
				if (
					cardData.data &&
					cardData.data.indicators &&
					Array.isArray(cardData.data.indicators)
				) {
		...
		},
		{
			...
			value: function calculateMarkdownHeight(cardData) {
				...
				if (
					...
					typeof cardData.data.content === "string"
				) {
					...
					try {
						for (_iterator12.s(); !(_step12 = _iterator12.n()).done; ) {
							...
							if (trimmedLine === "") {
								...
								var estimatedLines = Math.ceil(
									trimmedLine.length / charactersPerLine,
								)
		...
		},
		{
			...
			value: function getCompactCardSpec(card, totalCols) {
				...
				if (
					layoutMode === "tablet" &&
					(cardType === "markdown" || cardType === "text" || cardType === "image")
				) {
					return {
						w: Math.max(1, Math.floor(totalCols / 2)),
						h:
							cardType === "markdown"
								? this.calculateMarkdownHeight(card, layoutMode)
								: 5,
					}
				}
				var height = 6
			...
			value: function getCompactLayouts(cards, totalCols) {
				...
				var layoutMode =
					arguments.length > 2 && arguments[2] !== undefined
						...
						: this.getLayoutMode()
				var cacheKey = ""
					.concat(this.generateCardsHash(cards), "-")
					.concat(totalCols, "-")
					.concat(layoutMode)
		...
		},
		{
			...
			value: function shouldComponentUpdate(nextProps) {
				...
				if (
					...
					this.props.editorConfig !== nextProps.editorConfig ||
					this.props.dashboardConfig !== nextProps.dashboardConfig ||
		...
		},
		{
			...
			value: function ensureCompactEChartsTheme() {
				...
				var getTheme =
					typeof window.GET_ECHARTS_THEME_CONFIG === "function"
						? window.GET_ECHARTS_THEME_CONFIG
						: (_window$UTILS2 = window.UTILS) === null || _window$UTILS2 === void 0
							? void 0
							: _window$UTILS2.getDefaultEChartsThemeConfig
				if (window.echarts && typeof getTheme === "function") {
					var _window$UTILS3, _window$UTILS3$getCom
					var dashboardConfig = this.props.dashboardConfig
					var configForTheme =
						dashboardConfig && _typeof(dashboardConfig) === "object"
							? dashboardConfig
							: ((_window$UTILS3 = window.UTILS) === null ||
								_window$UTILS3 === void 0 ||
								(_window$UTILS3$getCom =
									_window$UTILS3.getComposeDashboardConfig) === null ||
								_window$UTILS3$getCom === void 0
									? void 0
									: _window$UTILS3$getCom.call(_window$UTILS3, {})) || {}
					try {
						var compactThemeConfig = getTheme(configForTheme)
						window.echarts.registerTheme(echartsThemeName, compactThemeConfig)
					} catch (error) {
						console.warn(
							"Failed to register compact ECharts theme: ".concat(echartsThemeName),
							error,
						)
					}
				}
		...
		},
		{
			...
			value: function render() {
				...
				var compactLayouts = this.getCompactLayouts(
					sortedCards,
					dashboardConfig.GRID_COLS,
					layoutMode,
				)
				var cardElements = sortedCards.map(function (cardConfig) {
					var className = "grid-item ".concat(
						layoutMode,
						"-grid-item non-draggable non-resizable non-hoverable",
					)
					var cardElement = visible
				...
				return React.createElement(
					React.Fragment,
					null,
					(_React2 = React).createElement.apply(
						_React2,
						[
							GridLayout,
							{
...
var GridDashboard = /*#__PURE__*/ (function (_React$Component18) {
	function GridDashboard(props) {
		...
		_this39.compactConfigCache = {
			mobile: {
				editorConfig:
					initialLayoutMode === "mobile"
						? (_window$UTILS4 = window.UTILS) === null || _window$UTILS4 === void 0
							? void 0
							: _window$UTILS4.createMobileEditorConfig(props.editorConfig)
						: null,
				dashboardConfig:
					initialLayoutMode === "mobile"
						? (_window$UTILS5 = window.UTILS) === null || _window$UTILS5 === void 0
							? void 0
							: _window$UTILS5.createMobileDashboardConfig(props.dashboardConfig)
						: null,
				lastEditorConfigRef: initialLayoutMode === "mobile" ? props.editorConfig : null,
				lastDashboardConfigRef:
					initialLayoutMode === "mobile" ? props.dashboardConfig : null,
			},
			tablet: {
				editorConfig:
					initialLayoutMode === "tablet"
						? (_window$UTILS6 = window.UTILS) === null || _window$UTILS6 === void 0
							? void 0
							: _window$UTILS6.createTabletEditorConfig(props.editorConfig)
						: null,
				dashboardConfig:
					initialLayoutMode === "tablet"
						? (_window$UTILS7 = window.UTILS) === null || _window$UTILS7 === void 0
							? void 0
							: _window$UTILS7.createTabletDashboardConfig(props.dashboardConfig)
						: null,
				lastEditorConfigRef: initialLayoutMode === "tablet" ? props.editorConfig : null,
				lastDashboardConfigRef:
					initialLayoutMode === "tablet" ? props.dashboardConfig : null,
			},
		}
	...
	return _createClass(GridDashboard, [
		...
		},
		{
			...
			value: function detectMobileDevice() {
				...
				var isPhoneUserAgent =
					/iphone|ipod|android.*mobile|windows phone|iemobile|opera mini|mobile|phone/i.test(
						userAgent,
					)
				var isPhoneScreen = shortSide <= 768 && longSide <= 1024
				var isPhoneMediaQuery =
					window.matchMedia && window.matchMedia("(max-width: 768px)").matches
				return Boolean(
					hasTouchSupport && (isPhoneUserAgent || isPhoneScreen || isPhoneMediaQuery),
				)
			},
		...
		},
		{
			...
			value: function detectTabletDevice() {
				...
				var shortSide = Math.min(window.innerWidth, window.innerHeight)
				var isTabletUserAgent = /ipad|tablet|playbook|silk|(android(?!.*mobile))/i.test(
					userAgent,
				)
				var isTabletScreen = shortSide > 768 && shortSide <= 1280 && longSide <= 1600
				var isTabletMediaQuery =
					window.matchMedia &&
					window.matchMedia("(min-width: 769px) and (max-width: 1280px)").matches
				return Boolean(
					hasTouchSupport && (isTabletUserAgent || isTabletScreen || isTabletMediaQuery),
				)
			},
		},
		{
			...
			value: function getCompactConfigs(layoutMode, editorConfig, dashboardConfig) {
				...
				var creators =
					layoutMode === "tablet"
						? {
								createEditorConfig:
									(_window$UTILS8 = window.UTILS) === null ||
									_window$UTILS8 === void 0
										? void 0
										: _window$UTILS8.createTabletEditorConfig,
								createDashboardConfig:
									(_window$UTILS9 = window.UTILS) === null ||
									_window$UTILS9 === void 0
										? void 0
										: _window$UTILS9.createTabletDashboardConfig,
							}
						: {
								createEditorConfig:
									(_window$UTILS0 = window.UTILS) === null ||
									_window$UTILS0 === void 0
										? void 0
										: _window$UTILS0.createMobileEditorConfig,
								createDashboardConfig:
									(_window$UTILS1 = window.UTILS) === null ||
									_window$UTILS1 === void 0
										? void 0
										: _window$UTILS1.createMobileDashboardConfig,
							}
				...
				var compactEditorConfig = creators.createEditorConfig
					? creators.createEditorConfig(editorConfig)
					: editorConfig
				var compactDashboardConfig = creators.createDashboardConfig
					? creators.createDashboardConfig(dashboardConfig)
					: dashboardConfig
		...
		},
		{
			...
			value: function getActiveDashboardConfig(layoutMode, editorConfig, dashboardConfig) {
				...
				return this.getCompactConfigs(layoutMode, editorConfig, dashboardConfig)
					.compactDashboardConfig
			},
		},
		{
		...
		},
		{
			...
			value: function checkAllCardsRenderComplete() {
				...
				if (allValidCardsComplete) {
					...
					var allCardsStatus = [].concat(
						_toConsumableArray(validCardsStatus),
						_toConsumableArray(skippedCardsStatus),
					)
		...
		},
		{
			...
			value: function calculateDynamicRowHeight() {
				...
				var maxRows = window.UTILS.ceil(
					(wrapperHeight + layoutMargin - layoutPadding + layoutPadding) /
						(config.GRID_DEFAULT_ROW_HEIGHT + layoutMargin),
					0,
				)
				var maxRowsHeight =
					maxRows * config.GRID_DEFAULT_ROW_HEIGHT +
					(maxRows - 1) * layoutMargin +
					layoutPadding * 2
		...
		},
		{
			...
			value: function handleResize() {
				...
				if (
					newRowHeight !== this.state.rowHeight ||
					newLayoutMode !== this.state.layoutMode
				) {
					this.setState({
		...
		},
		{
			...
			value: function componentDidMount() {
				...
				var configToApply = this.getActiveDashboardConfig(
					this.state.layoutMode,
					this.props.editorConfig,
					this.props.dashboardConfig,
				)
				if (
					(_window$DashboardFram = window.DashboardFramework) !== null &&
					_window$DashboardFram !== void 0 &&
					_window$DashboardFram.applyThemeStyles &&
					configToApply
				) {
		...
		},
		{
			...
			value: function componentDidUpdate(prevProps, prevState) {
				if (prevProps.renderMode !== this.props.renderMode) {
					...
					if (
						prevState.layoutMode !== nextLayoutMode ||
						prevState.rowHeight !== nextRowHeight
					) {
						this.setState({
				...
				if (
					prevProps.editorConfig !== this.props.editorConfig ||
					prevProps.dashboardConfig !== this.props.dashboardConfig
				) {
				...
				if (
					...
					if (
						(_window$DashboardFram2 = window.DashboardFramework) !== null &&
						_window$DashboardFram2 !== void 0 &&
						_window$DashboardFram2.applyThemeStyles &&
						configToApply
					) {
						window.DashboardFramework.applyThemeStyles(configToApply)
					}
			...
			value: function createCardFromConfig(cardConfig) {
				for (
					var _len2 = arguments.length,
						additionalProps = new Array(_len2 > 1 ? _len2 - 1 : 0),
						_key2 = 1;
					_key2 < _len2;
					_key2++
				) {
				...
				var extraProps =
					additionalProps.length > 0
						? Object.assign.apply(Object, [{}].concat(additionalProps))
						: {}
				return React.createElement(
					window.BaseCard,
					_objectSpread(
						_objectSpread({}, cardConfig),
						{},
						{
		...
		},
		{
			...
			value: function filterCardsAndCollectWarnings(cards, source) {
				...
				if (cardsWithoutLayout.length > 0 && window.ErrorCollector) {
					window.ErrorCollector.collectCardsWithoutLayoutWarning(
						cardsWithoutLayout,
						cards.length,
						source,
					)
		...
		},
		{
			...
			value: function renderCompactLayout() {
				...
				// Filter cards and collect layout warnings
				var validCards = this.filterCardsAndCollectWarnings(
					cards,
					"GridDashboard.renderCompactLayout",
				)
				var _this$getCompactConfi = this.getCompactConfigs(
						layoutMode,
						editorConfig,
						dashboardConfig,
					),
		...
		},
		{
			...
			value: function renderDesktopLayout() {
				...
				var validCards = this.filterCardsAndCollectWarnings(
					cards,
					"GridDashboard.renderDesktopLayout",
				)
				...
				var cardElements = validCards.map(function (cardConfig) {
					var isDraggable =
						(editorConfig === null || editorConfig === void 0
							? void 0
							: editorConfig.DRAGGABLE) || false
					var isHoverable = dashboardConfig.INTERACTION_CARD_HOVERABLE
					var className = "grid-item desktop-grid-item "
						.concat(isDraggable ? "draggable" : "non-draggable", " ")
						.concat(isHoverable ? "hoverable" : "")
					return React.createElement(
						"div",
						{
							key: cardConfig.id,
						...
						visible
							? _this43.createCardFromConfig(cardConfig, {
									editorConfig: editorConfig,
									dashboardConfig: dashboardConfig,
				...
				return React.createElement(
					React.Fragment,
					null,
					(_React3 = React).createElement.apply(
						_React3,
						[
							GridLayout,
							{
		...
		},
		{
			...
			value: function render() {
				...
				return this.isCompactLayout(layoutMode)
	...
	return _createClass(Dashboard, [
			...
			value: function notifyEmptyDashboardIfNeeded(cardsOverride) {
				var cards =
					cardsOverride !== undefined
						? cardsOverride
						: this.state.cards || this.props.dashboardCards
		...
		},
		{
			...
			value: function handleAllCardsRenderComplete(renderInfo) {
				...
				console.log(
					"[Dashboard] All cards rendering completed - Total: "
						.concat(totalCards, ", Rendered: ")
						.concat(renderedCards, ", Success: ")
						.concat(successCount, ", Failed: ")
						.concat(errorCount, ", Skipped: ")
						.concat(skippedCount, " (Source: ")
						.concat(window.ErrorCollector ? "ErrorCollector" : "RenderStatus", ")"),
				)
			...
			value: function hasLayoutChanged(newLayouts) {
				...
				try {
					return this.state.cards.some(function (card) {
						...
						return (
							newLayoutItem &&
							(currentLayout.x !== newLayoutItem.x ||
								currentLayout.y !== newLayoutItem.y ||
								currentLayout.w !== newLayoutItem.w ||
								currentLayout.h !== newLayoutItem.h)
						)
					})
				} catch (error) {
		...
		},
		{
			...
			value: function componentDidUpdate(prevProps) {
				...
				var cardsFromParentChanged = this.hasCardsChanged(
					prevProps.dashboardCards,
					propsCards,
				)
				if (cardsFromParentChanged) {
					this.updateCardsState(propsCards)
				}
				var cardsForEmptyCheck = cardsFromParentChanged
					? propsCards
					: this.state.cards || propsCards
		...
		},
		{
			...
			value: function render() {
				...
				var isDashboardReady =
					((_window$magicDashboar3 = window.magicDashboard) === null ||
					_window$magicDashboar3 === void 0
						? void 0
						: _window$magicDashboar3.ready) === true
...
function initializeEChartsTheme() {
	...
	var getTheme =
		typeof window.GET_ECHARTS_THEME_CONFIG === "function"
			? window.GET_ECHARTS_THEME_CONFIG
			: window.UTILS.getDefaultEChartsThemeConfig
	var mergedDashboardConfig = window.UTILS.getComposeDashboardConfig(
...
function DashboardApp() {
	var _window$magicDashboar4,
		_window$magicDashboar5,
		_window$magicDashboar6,
		_window$magicDashboar7,
		_window$magicDashboar8,
		_window$magicDashboar9,
		_window$magicDashboar0
	var _React4 = React,
		useState = _React4.useState
	var _useState = useState(
			((_window$magicDashboar4 = window.magicDashboard) === null ||
			_window$magicDashboar4 === void 0
				? void 0
				: _window$magicDashboar4.geo) || [],
		),
		_useState2 = _slicedToArray(_useState, 2),
		geoConfig = _useState2[0],
		setGeoConfig = _useState2[1]
	var _useState3 = useState(
			normalizeRuntimeRenderMode(
				(_window$magicDashboar5 = window.magicDashboard) === null ||
					_window$magicDashboar5 === void 0
					? void 0
					: _window$magicDashboar5.renderMode,
			),
		),
	...
	var _useState5 = useState({
			EDITABLE:
				((_window$magicDashboar6 = window.magicDashboard) === null ||
				_window$magicDashboar6 === void 0
					? void 0
					: _window$magicDashboar6.editable) || false,
			DRAGGABLE:
				((_window$magicDashboar7 = window.magicDashboard) === null ||
				_window$magicDashboar7 === void 0
					? void 0
					: _window$magicDashboar7.draggable) || false,
			RESIZABLE:
				((_window$magicDashboar8 = window.magicDashboard) === null ||
				_window$magicDashboar8 === void 0
					? void 0
					: _window$magicDashboar8.resizable) || false,
			DELETABLE:
				((_window$magicDashboar9 = window.magicDashboard) === null ||
				_window$magicDashboar9 === void 0
					? void 0
					: _window$magicDashboar9.deletable) || false,
			EXPANDABLE:
				((_window$magicDashboar0 = window.magicDashboard) === null ||
				_window$magicDashboar0 === void 0
					? void 0
					: _window$magicDashboar0.expandable) || false,
		}),
	...
	var _useState9 = useState(
			window.DASHBOARD_CONFIG !== undefined && window.DASHBOARD_CONFIG !== null
				? window.DASHBOARD_CONFIG
				: {},
		),
	...
	var composeDashboardConfig = React.useMemo(
		function () {
	...
	var configManager = React.useMemo(
		function () {
			return {
...
window.DashboardFramework = {
	...
	// Style functions
	applyThemeStyles:
		(_window$StyleUtils = window.StyleUtils) === null || _window$StyleUtils === void 0
			? void 0
			: _window$StyleUtils.applyThemeStyles,
	formatCSSValue:
		(_window$StyleUtils2 = window.StyleUtils) === null || _window$StyleUtils2 === void 0
			? void 0
			: _window$StyleUtils2.formatCSSValue,
}
