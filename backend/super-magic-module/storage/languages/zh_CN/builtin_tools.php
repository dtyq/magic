...
return [
    ...
    'descriptions' => [
        ...
        'delete_file' => '文件删除工具，用于删除指定的文件或目录，只能删除工作目录中的文件，操作前请确认文件路径正确',
        ...
        'text_to_image' => '文本生成图片工具，根据文本提示词生成图片，支持多种模型选择，可自定义尺寸、数量和输出路径',
        'image_edit' => '图片编辑工具，使用文本提示编辑图片，支持背景替换、物体移除等操作，仅支持qwen-image-edit模型',
