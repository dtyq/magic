...
import { MagicSelect } from "@/opensource/components/base"
				...
				>
					...
					<div
						className={`${styles.diffLine} ${
							isAddition ? styles.conflictResolved : styles.changeResolvedDeletion
	...
	change.lines.forEach((line, lineIdx) => {
		...
		result.push(
			<div key={`change-line-${change.id}-${lineIdx}`} className={styles.codeLineWithNumber}>
				...
				<div
					className={`${styles.diffLine} ${isAddition ? styles.added : styles.deleted} ${
						styles.inlineCodeContent
					}`}
				>
					{line}
