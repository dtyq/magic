import type { GetFileInfoResponse } from "@/opensource/components/CanvasDesign/types.magic"
import {
	parseExpiresAt,
	isOssExpired,
} from "@/opensource/components/CanvasDesign/canvas/utils/ossExpiryUtils"
