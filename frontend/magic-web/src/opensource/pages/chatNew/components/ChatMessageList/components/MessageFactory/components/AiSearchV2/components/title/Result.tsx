...
import type { SearchWebPage } from "@/opensource/types/chat/conversation_message"
...
interface ResultProps {
	...
	searchWebPages?: SearchWebPage[]
	pageLength?: number
}

const Result = memo(({ deepLevel = 1, searchWebPages, pageLength = 0 }: ResultProps) => {
