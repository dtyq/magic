...
vi.mock("@/opensource/components/base/MagicFileIcon", () => ({
...
vi.mock("@/opensource/pages/superMagic/assets/svg/file-folder.svg", () => ({
...
vi.mock("@/opensource/components/MessageEditor/hooks/useFileUpload", () => ({
	useFileUpload: () => ({
		addFiles: vi.fn(),
		uploading: false,
	}),
...
// Mock chatWebSocket
vi.mock("@/opensource/apis/clients/chatWebSocket", () => ({
	default: {
		on: vi.fn(),
		off: vi.fn(),
		emit: vi.fn(),
...
vi.mock("@/opensource/services/groupInfo", () => ({
	default: {
		init: vi.fn(),
		getGroupInfo: vi.fn(),
	},
...
vi.mock("@/opensource/services/userInfo", () => ({
	default: {
		init: vi.fn(),
		getUserInfo: vi.fn(),
	},
...
vi.mock("@/opensource/database/chat", () => ({
	default: {
		init: vi.fn(),
		getMessages: vi.fn(),
	},
...
vi.mock("@/opensource/services/chat/message/MessageSeqIdService", () => ({
	default: {
		init: vi.fn(),
		getSeqId: vi.fn(),
	},
...
vi.mock("@/opensource/services/chat/message/MessageService", () => ({
	default: {
		init: vi.fn(),
		sendMessage: vi.fn(),
	},
...
vi.mock("@/opensource/services/file/KnowledgeFile", () => ({
