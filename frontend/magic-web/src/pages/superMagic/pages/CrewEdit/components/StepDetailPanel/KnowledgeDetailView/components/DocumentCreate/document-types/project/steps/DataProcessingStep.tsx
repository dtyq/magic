 ...
 * Project第3步：数据处理
 * 在已有知识库中创建文档并显示处理进度
 * 设计稿: https://www.figma.com/design/6Y4cUmZyEJnas4qKtbcJ5Y/Magic---SuperMagic-Shadcn?node-id=14854-2315010
 */
		...
		try {
			...
			if (editDocumentCode) {
				...
				const result = await KnowledgeApi.updateCrewKnowledge({
					code: knowledgeCode,
					source_type: CrewKnowledge.KnowledgeSourceType.PROJECT_FILE,
					fragment_config: fragmentConfig,
