...
use Dtyq\SuperMagic\Application\SuperAgent\Service\FileConvertStatusManager;
    ...
    public function __invoke(): array
    {
        ...
        return [
            ...
            'dependencies' => [
                ...
                // 添加FileConvertStatusManager的依赖注入
                FileConvertStatusManager::class => FileConvertStatusManager::class,
                // 添加分享相关服务
