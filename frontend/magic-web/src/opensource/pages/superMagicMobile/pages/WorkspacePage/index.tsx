...
import IconWorkspaceCase from "@/opensource/components/icons/IconWorkspaceCase"
import WorkspaceCase from "../../components/WorkspaceCase"
import MessagePanelSkeleton from "@/opensource/pages/superMagic/components/EmptyWorkspacePanel/components/MessagePanelSkeleton"
import { isPrivateDeployment } from "@/opensource/utils/env"
import Slogan from "@/opensource/pages/superMagic/components/EmptyWorkspacePanel/components/Slogan"
import IconWorkspaceProjectStar from "@/opensource/enhance/tabler/icons-react/icons/IconWorkspaceProjectStar"
import { DEFAULT_MOBILE_LAYOUT_CONFIG } from "@/opensource/pages/superMagic/components/MessageEditor/constants/constant"
import { cn } from "@/opensource/lib/utils"
import { useEmptyStateHandlers } from "@/opensource/pages/superMagic/hooks/useEmptyStateHandlers"
import { resetDocumentScrollPosition } from "@/opensource/utils/scroll"
import EditionActivityBanner from "@/opensource/components/business/EditionActivity/Banner"

const MessagePanel = lazy(() => import("@/opensource/pages/superMagic/components/MessagePanel"))
