...
import MobileInputContainer from "@/opensource/pages/superMagicMobile/pages/ChatPage/components/MobileInputContainer"
...
const ProjectPageInputContainerComponent: React.FC<ProjectPageInputContainerProps> = ({
	...
	const editorSize = "default" as MessageEditorSize
