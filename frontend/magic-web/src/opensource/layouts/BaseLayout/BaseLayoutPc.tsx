...
import useMetaSet from "@/opensource/routes/hooks/useRoutesMetaSet"
import { MultiFolderUploadToast } from "@/opensource/components/global/MultiFolderUploadToast"
import {
	ResizablePanelGroup,
	ResizablePanel,
	ResizableHandle,
} from "@/opensource/components/shadcn-ui/resizable"
import type { ImperativePanelHandle } from "react-resizable-panels"
import { sidebarStore } from "@/opensource/stores/layout"
import MagicSidebar from "./components/MagicSidebar"
import { cn } from "@/opensource/lib/utils"
import { initializeSuperMagicIfNeeded } from "@/opensource/pages/superMagic/services/utils"
import { useSidebarAnimation, useSidebarResponsive } from "./hooks"
import { globalShareManagementStore } from "@/opensource/pages/superMagic/components/ShareManagement/stores"
...
function getSuperRouteParams(pathname: string): {
	...
	return {
		workspaceId: pathParts[superIndex + 1] || undefined,
		projectId: pathParts[superIndex + 2] || undefined,
		topicId: pathParts[superIndex + 3] || undefined,
	}
}
