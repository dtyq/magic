...
return [
    ...
    'descriptions' => [
        ...
        'text_to_image' => 'Text-to-image generation tool, generates images based on text prompts, supports multiple model selection, allows customizing size, quantity and output path',
        'image_edit' => 'Image editing tool, uses text prompts to edit images, supports background replacement, object removal and other operations, only supports qwen-image-edit model',
