...
import { internetSearchManager } from "@/opensource/pages/superMagic/components/MessageEditor/services/InternetSearchManager"
...
export class MagicPlatformService implements PlatformServiceInterface {
	...
	initSuperMagicDataIfNeeded = async ({
		...
		const { default: SuperMagicService } =
			await import("@/opensource/pages/superMagic/services/index")
