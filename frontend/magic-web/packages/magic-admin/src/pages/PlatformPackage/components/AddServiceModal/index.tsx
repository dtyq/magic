...
import type { Lang, MagicModalProps } from "@admin-components"
import { MagicSelect, MultiLangSetting, MagicModal, LanguageType } from "@admin-components"
...
export const AddServiceModal = ({
	...
	const onChange = (value: string) => {
		...
		const code = provider?.code as AiModel.ServiceProvider

		const defaultApiUrl = AiModel.ServiceProviderUrl[code]
		if (defaultApiUrl) form.setFieldValue(["config", "url"], defaultApiUrl)
	}
