...
import type { TabStatus } from "@/opensource/services/recordSummary/TabCoordinator"
import {
	VoiceResult,
	VoiceResultUtterance,
} from "@/opensource/components/business/VoiceInput/services/VoiceClient/types"
...
import { formatDuration } from "@/opensource/services/recordSummary/utils/format"
...
class RecordingSummaryStore {
	...
	businessData = {
		...
		audioSource: undefined as
			| import("@/opensource/types/recordSummary").AudioSourceConfig
			| undefined,
	}
	 ...
	 */
	setAudioSource(
		audioSource: import("@/opensource/types/recordSummary").AudioSourceConfig | undefined,
	) {
