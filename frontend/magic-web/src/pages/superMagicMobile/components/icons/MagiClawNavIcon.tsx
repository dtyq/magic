...
/**
 * MagiClaw sidebar nav icon: 16×16 artboard, 1.25 stroke to match Lucide at `size-4` (16px).
 * Intended for `NavMenuIcon` only — larger containers make the stroke look disproportionately thick.
 */
