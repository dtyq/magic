...
} from "@/opensource/pages/superMagic/components/MessageEditor/MessageEditor"
import { useIsMobile } from "@/opensource/hooks/useIsMobile"
import {
	createMessageSendService,
	type HandleSendParams,
} from "@/opensource/pages/superMagic/services/messageSendFlowService"
import { roleStore } from "@/opensource/pages/superMagic/stores"
import { projectStore, topicStore, workspaceStore } from "@/opensource/pages/superMagic/stores/core"
import useSharedProjectMode from "@/opensource/pages/superMagic/hooks/useSharedProjectMode"
import superMagicModeService from "@/opensource/services/superMagic/SuperMagicModeService"
import useSandboxPreWarm from "@/opensource/pages/superMagic/components/MessagePanel/hooks/useSandboxPreWarm"
import { useNanoBananaPrompt } from "@/opensource/pages/superMagic/hooks/useNanoBananaPrompt"
import useTopicExamplesPortal from "@/opensource/pages/superMagic/hooks/useTopicExamplesPortal"
...
import { generateTextFromJSONContent } from "@/opensource/pages/superMagic/components/MessageEditor/utils"
...
export default function DefaultMessageEditorContainer({
	editorContext,
	editorNodes,
	editorRef,
}: DefaultMessageEditorContainerProps) {
	...
	useEffect(() => {
		...
		const timer = setTimeout(() => {
			...
			const handleUpdate = () => {
				...
				if (e && !e.isDestroyed) editorContext.onContentChange!(e.getJSON())
			}
