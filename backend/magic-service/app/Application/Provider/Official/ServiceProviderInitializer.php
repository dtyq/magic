    ...
    private static function getProviderData(string $orgCode): array
    {
        ...
        return [
            ...
            [
                ...
                'sort_order' => 992,
                'description' => 'MiniMax 是一家领先的 AI 大模型公司，提供高性能的 MiniMax-M3（默认，512K 上下文、最大输出 128K、支持图片输入）、MiniMax-M2.7 和 MiniMax-M2.7-highspeed 系列模型，支持超长上下文、工具调用和深度思考能力，通过 OpenAI 兼容接口提供服务。',
                'icon' => 'MAGIC/713471849556451329/default/default.png',
                'provider_type' => 0,
                'category' => 'llm',
                'status' => 1,
                ...
                'translate' => json_encode([
                    ...
                    'description' => [
                        'en_US' => 'MiniMax is a leading AI large model company, providing high-performance MiniMax-M3 (default, 512K context, up to 128K output, with image input), MiniMax-M2.7 and MiniMax-M2.7-highspeed series models with long context, tool calling and deep thinking capabilities, served via an OpenAI-compatible API.',
                        'zh_CN' => 'MiniMax 是一家领先的 AI 大模型公司，提供高性能的 MiniMax-M3（默认，512K 上下文、最大输出 128K、支持图片输入）、MiniMax-M2.7 和 MiniMax-M2.7-highspeed 系列模型，支持超长上下文、工具调用和深度思考能力，通过 OpenAI 兼容接口提供服务。',
                    ],
                ]),
                'remark' => '',
            ],
