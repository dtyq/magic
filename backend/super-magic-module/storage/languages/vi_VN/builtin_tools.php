...
return [
    'names' => [
        ...
        'summarize' => 'Tóm tắt',
        'text_to_image' => 'Văn bản thành hình ảnh',
        'image_edit' => 'Chỉnh sửa hình ảnh',
    ...
    'descriptions' => [
        ...
        'text_to_image' => 'Công cụ tạo hình ảnh từ văn bản, tạo hình ảnh dựa trên lời nhắc văn bản, hỗ trợ lựa chọn nhiều mô hình, cho phép tùy chỉnh kích thước, số lượng và đường dẫn đầu ra',
        'image_edit' => 'Công cụ chỉnh sửa hình ảnh, sử dụng lời nhắc văn bản để chỉnh sửa hình ảnh, hỗ trợ thay thế nền, loại bỏ đối tượng và các thao tác khác, chỉ hỗ trợ mô hình qwen-image-edit',
