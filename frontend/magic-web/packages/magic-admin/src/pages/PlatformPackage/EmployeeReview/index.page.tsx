...
const EmployeeReviewCard = lazy(() => import("./EmployeeReviewCard"))
...
function EmployeeReviewPage() {
	...
	const hasEditRight = useRights(PERMISSION_KEY_MAP.PLATFORM_EMPLOYEE_REVIEW_EDIT)
				...
				render: (_, record) => {
					...
					return (
						<Flex align="center" gap={8}>
							<Button
								type="link"
								disabled={disabled || rowLoading || !hasEditRight}
				...
				<MobileList<ParamsType, DataType>
					...
					CardComponent={
						<EmployeeReviewCard
							...
							publishTargetTypeMap={publishTargetTypeMap}
